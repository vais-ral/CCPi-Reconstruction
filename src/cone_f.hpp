				       ...
				       const int nz_voxels)
{
  ...
  real start[3], end[3];
#pragma omp parallel for shared(det_y, det_z, ray_data, phi) private(curr_angle, curr_ray_y, curr_ray_z, start, end, cos_curr_angle, sin_curr_angle) schedule(dynamic)
