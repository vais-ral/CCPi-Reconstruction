function [ pix_per_vox niterations beam_harden ok ] = input_recon_data( )
%input_recon_data
%   GUI function to get user settings for 
%      - number of pixels per voxel
